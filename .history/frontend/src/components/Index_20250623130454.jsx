        ...
        <div>
            <div className="banner">
                ...
                <div className="contents">
                    ...
                    <div>
                        <button type="submit"><span></span><a href="/currentdrives">Current Drives</a></button>
                    </div>
                ...
                <div>
                    <footer
                    id='footer'
                        className=" footer flex flex-col items-center bg-palette-900 text-center text-white mt-32">
